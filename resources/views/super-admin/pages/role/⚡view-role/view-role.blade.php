<div>
    ...
    <div
        ...
        <!-- Card -->
        <div class="flex flex-col rounded-xl border border-transparent p-4 sm:p-6 lg:p-8 bg-green-50 shadow-2xl">
                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center">
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-700 text-white shadow-2xs hover:bg-green-600 focus:outline-hidden focus:bg-green-700"
                                        href="#">
                                        View all
                                    </a>
                                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-700 text-white hover:bg-green-600 focus:outline-hidden focus:bg-green-700"
